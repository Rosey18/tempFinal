			...
			<div class="card-body">
				...
				<form action="AdminServlet" method="GET" class="form">
					...
					<div class="input-group mt-3">
						...
						<input type="text" name="trainNum" class="form-control" style="width:75%;"/>
					</div>
					<div class="input-group mt-3">
						<div class="form-text-prepend" style="width: 150px;">
								<span class="input-group-text">
						...
						<input type="text" name="departure" class="form-control" style="width:75%;"/>
					</div>
					<div class="input-group mt-3">
						<div class="form-text-prepend" style="width: 150px;">
								<span class="input-group-text">
						...
						<input type="text" name="arrival" class="form-control" style="width:75%;"/>
					</div>
					<div class="input-group mt-3">
						<div class="form-text-prepend" style="width: 150px;">
								<span class="input-group-text">
						...
						<input type="text" name="carriage" class="form-control" style="width:75%;"/>
					</div>
					<div class="input-group mt-3">
						<div class="form-text-prepend" style="width: 150px;">
								<span class="input-group-text">
						...
						<input type="text" name="seat" class="form-control" style="width:75%;"/>
					</div>
					<div class="input-group mt-3">
						<div class="form-text-prepend" style="width: 150px;">
								<span class="input-group-text">
						...
						<input type="text" name="price" class="form-control" style="width:75%;"/>
					</div>
